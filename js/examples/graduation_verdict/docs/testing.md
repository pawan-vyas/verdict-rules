...
both (557 tests in this project as of this writing -- 57 curated
scenarios, 500 chaos cases). Also picked up by the workspace root's own
`npm test`, alongside `verdict-rules`' own suite, no extra configuration
needed.
