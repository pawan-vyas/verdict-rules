<!-- Title: Verdict Sample Specs -->
# Verdict — sample specs

> Language-agnostic specs for the worked samples, one directory per
> scenario. Each spec here is read once and implemented per language;
> see [`../maintenance/doc-authoring/samples.md`](../maintenance/doc-authoring/samples.md)
> for the template these follow.

| Spec | The question it answers |
| --- | --- |
| [`dynamic-discounts/`](dynamic-discounts/README.md) | Does this cart qualify for a promotion? |
| [`shipping-fee-waiver/`](shipping-fee-waiver/README.md) | Does this order ship free? |
| [`loyalty-tier-promotion/`](loyalty-tier-promotion/README.md) | Should this customer be promoted to the next tier? |
