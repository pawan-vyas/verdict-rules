...
> ([#90](https://github.com/pawan-vyas/verdict-rules/pull/90), open), with no
...
> fixture) and §4 (the core migration) no longer land as "Dart's own PR" at
...
> not before it. §5 (docs) also folds into that single PR, for Dart's own
